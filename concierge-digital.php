...
function render_question_manager_page()
{
    ...
    echo '<label>Opções:</label> <button type="button" id="toggle_options" style="margin-left: 10px;">Adicionar Opções</button><br>';
    echo '<div id="options_container" style="display: none; margin-top: 10px;">';
    echo '<label for="question_options">Opções (separadas por vírgula):</label><br>';
    echo '<input type="text" id="question_options" name="question_options"><br>';
    echo '</div>';
    ...
    if (isset($_GET['delete'])) {
        $questionManager->deleteQuestion((int)$_GET['delete']);
        echo "<div class='updated'><p>Pergunta excluída com sucesso!</p></div>";
    }
